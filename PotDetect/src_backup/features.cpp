...
MySVM get_svm(){
	...
	string svm_file_path="/home/odroid/catkin_ws_new/src/PotDetect/svm_pot_available.xml";
	//MySVM svm=ml::SVM::load(svm_file_path);
	MySVM svm=cv::Algorithm::load<cv::ml::SVM>("/home/odroid/catkin_ws_new/src/PotDetect/svm_pot_available.xml");
	return svm;
}
...
void feat_train_svm(int iter){
	...
	string svm_file_path="/home/odroid/catkin_ws_new/src/PotDetect/svm_pot.xml";
	ifstream in;
